...
class ColoniaCodigoPostal extends Model
{
    ...
    */
    ...
    FROM
         ...
         LEFT JOIN SWIITL.dbo.CAT_CIUDAD              ON CATR_CODIGO_POSTAL.FK_CIUDAD                     = CAT_CIUDAD.PK_CIUDAD
         LEFT JOIN SWIITL.dbo.CAT_ENTIDAD_FEDERATIVA   ON CAT_CIUDAD.FK_ENTIDAD_FEDERATIVA                = CAT_ENTIDAD_FEDERATIVA.PK_ENTIDAD_FEDERATIVA
