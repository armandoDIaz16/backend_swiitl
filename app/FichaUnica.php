...
class FichaUnica extends Model
{
    ...
    public function alumnos($id, $y){
        ...
        SELECT CAT_USUARIO.NOMBRE as NOMBREALUMNO, CAT_USUARIO.PRIMER_APELLIDO, CAT_USUARIO.SEGUNDO_APELLIDO, CATR_CARRERA.NOMBRE, CATR_ALUMNO.NUMERO_CONTROL, CAT_USUARIO.CORREO1, CAT_ANTEPROYECTO_RESIDENCIA.NOMBRE AS Proyecto,
CAT_ANTEPROYECTO_RESIDENCIA.Empresa,(SELECT CAT_USUARIO.NOMBRE FROM CAT_USUARIO
JOIN CATR_DOCENTE ON CAT_USUARIO.PK_USUARIO = CATR_DOCENTE.ID_PADRE
...
(SELECT CAT_USUARIO.PRIMER_APELLIDO
FROM CAT_USUARIO
JOIN CATR_EXTERNO ON CAT_USUARIO.PK_USUARIO = CATR_EXTERNO.ID_PADRE
JOIN CATR_PROYECTO ON CATR_EXTERNO.ID_PADRE = CATR_PROYECTO.FK_ASESOR_EXT
WHERE CATR_PROYECTO.PK_PROYECTO = @Proyecto) AS ApellidoPExterno,
(SELECT CAT_USUARIO.SEGUNDO_APELLIDO
FROM CAT_USUARIO
JOIN CATR_EXTERNO ON CAT_USUARIO.PK_USUARIO = CATR_EXTERNO.ID_PADRE
JOIN CATR_PROYECTO ON CATR_EXTERNO.ID_PADRE = CATR_PROYECTO.FK_ASESOR_EXT
...
WHERE PER_CAT_ROL.NOMBRE = \'Residente\'
