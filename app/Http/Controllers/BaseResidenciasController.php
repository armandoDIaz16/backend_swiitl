...
CAT_USUARIO.NOMBRE as NOMBREALUMNO,
CAT_USUARIO.PRIMER_APELLIDO, 
CAT_USUARIO.SEGUNDO_APELLIDO, 
(select NOMBRE from CAT_USUARIO JOIN CATR_DOCENTE ON CAT_USUARIO.PK_USUARIO = CATR_DOCENTE.ID_PADRE JOIN CATR_PROYECTO ON CATR_DOCENTE.ID_PADRE = CATR_PROYECTO.FK_DOCENTE WHERE FK_ANTEPROYECTO = FK_ANTEPROYECTO) as NOMBREDOCENTE,
(select PRIMER_APELLIDO from CAT_USUARIO JOIN CATR_DOCENTE ON CAT_USUARIO.PK_USUARIO = CATR_DOCENTE.ID_PADRE JOIN CATR_PROYECTO ON CATR_DOCENTE.ID_PADRE = CATR_PROYECTO.FK_DOCENTE WHERE FK_ANTEPROYECTO = FK_ANTEPROYECTO) as PRIMERADOCENTE,
(select SEGUNDO_APELLIDO from CAT_USUARIO JOIN CATR_DOCENTE ON CAT_USUARIO.PK_USUARIO = CATR_DOCENTE.ID_PADRE JOIN CATR_PROYECTO ON CATR_DOCENTE.ID_PADRE = CATR_PROYECTO.FK_DOCENTE WHERE FK_ANTEPROYECTO = FK_ANTEPROYECTO) as SEGUNDOADOCENTE,
(select NOMBRE from CAT_USUARIO JOIN CATR_EXTERNO ON CAT_USUARIO.PK_USUARIO = CATR_EXTERNO.ID_PADRE JOIN CATR_PROYECTO ON CATR_EXTERNO.ID_PADRE = CATR_PROYECTO.FK_ASESOR_EXT WHERE FK_ANTEPROYECTO = FK_ANTEPROYECTO) as NOMBREEXTERNO,
(select PRIMER_APELLIDO from CAT_USUARIO JOIN CATR_EXTERNO ON CAT_USUARIO.PK_USUARIO = CATR_EXTERNO.ID_PADRE JOIN CATR_PROYECTO ON CATR_EXTERNO.ID_PADRE = CATR_PROYECTO.FK_ASESOR_EXT WHERE FK_ANTEPROYECTO = FK_ANTEPROYECTO) as PRIMERAEXTERNO,
(select SEGUNDO_APELLIDO from CAT_USUARIO JOIN CATR_EXTERNO ON CAT_USUARIO.PK_USUARIO = CATR_EXTERNO.ID_PADRE JOIN CATR_PROYECTO ON CATR_EXTERNO.ID_PADRE = CATR_PROYECTO.FK_ASESOR_EXT WHERE FK_ANTEPROYECTO = FK_ANTEPROYECTO) as SEGUNDOAEXTERNO,
