...
(
    ...
    FK_PERIODO              INT      NOT NULL
        CONSTRAINT CAT_TURNO_FK_PERIODO_FOREIGN REFERENCES dbo.CAT_PERIODO_PREFICHAS,
    ESTADO                  SMALLINT NOT NULL DEFAULT 1,
    FK_USUARIO_REGISTRO     INT,
    FK_USUARIO_MODIFICACION INT,
    FECHA_REGISTRO          DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    CAPACIDAD               INT,
    FK_PERIODO              INT      NOT NULL
        CONSTRAINT CATR_ESPACIO_FK_PERIODO_FOREIGN REFERENCES dbo.CAT_PERIODO_PREFICHAS,
    ESTADO                  SMALLINT NOT NULL DEFAULT 1,
    FK_USUARIO_REGISTRO     INT,
    FK_USUARIO_MODIFICACION INT,
    FECHA_REGISTRO          DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    FK_PERIODO              INT      NOT NULL
        CONSTRAINT CATR_EXAMEN_ADMISION_FK_PERIODO_FOREIGN REFERENCES dbo.CAT_PERIODO_PREFICHAS,
    ESTADO                  SMALLINT NOT NULL DEFAULT 1,
    FK_USUARIO_REGISTRO     INT,
    FK_USUARIO_MODIFICACION INT,
    FECHA_REGISTRO          DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    FK_CARRERA              INT      NOT NULL
        CONSTRAINT TR_CARRERA_CAMPUS_FK_CARRERA_FOREIGN REFERENCES dbo.CAT_CARRERA,
    FK_CAMPUS               INT      NOT NULL
        CONSTRAINT TR_CARRERA_CAMPUS_FK_CAMPUS_FOREIGN REFERENCES dbo.CAT_CAMPUS,
    ESTADO                  SMALLINT NOT NULL DEFAULT 1,
    FK_USUARIO_REGISTRO     INT,
    FK_USUARIO_MODIFICACION INT,
    FECHA_REGISTRO          DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    FK_CARRERA_1              INT           NOT NULL
        CONSTRAINT CAT_ASPIRANTE_FK_CARRERA_1_FOREIGN REFERENCES dbo.TR_CARRERA_CAMPUS,
    FK_CARRERA_2              INT
        CONSTRAINT CAT_ASPIRANTE_FK_CARRERA_2_FOREIGN REFERENCES dbo.TR_CARRERA_CAMPUS,
