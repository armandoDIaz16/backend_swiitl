...
CREATE TABLE dbo.CAT_TURNO 
  ( 
     ...
     DIA                     DATE, 
     HORA                    VARCHAR(15),
     FK_PERIODO                INT NOT NULL CONSTRAINT CAT_TURNO_FK_PERIODO_FOREIGN REFERENCES dbo.CAT_PERIODO_PREFICHAS,
     ESTADO                      SMALLINT NOT NULL DEFAULT 1, 
     FK_USUARIO_REGISTRO         INT, 
     FK_USUARIO_MODIFICACION     INT, 
     FECHA_REGISTRO              DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, 
...
CREATE TABLE dbo.CATR_ESPACIO 
  ( 
     ...
     CAPACIDAD               INT, 
  FK_PERIODO                INT NOT NULL CONSTRAINT CATR_ESPACIO_FK_PERIODO_FOREIGN REFERENCES dbo.CAT_PERIODO_PREFICHAS,
          ESTADO                      SMALLINT NOT NULL DEFAULT 1, 
     FK_USUARIO_REGISTRO         INT, 
     FK_USUARIO_MODIFICACION     INT, 
     FECHA_REGISTRO              DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, 
...
CREATE TABLE dbo.CATR_EXAMEN_ADMISION 
  ( 
     ...
     FK_PERIODO                INT NOT NULL CONSTRAINT CATR_EXAMEN_ADMISION_FK_PERIODO_FOREIGN REFERENCES dbo.CAT_PERIODO_PREFICHAS,
     ESTADO                      SMALLINT NOT NULL DEFAULT 1, 
     FK_USUARIO_REGISTRO         INT, 
     FK_USUARIO_MODIFICACION     INT, 
     FECHA_REGISTRO              DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, 
