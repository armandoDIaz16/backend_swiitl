...
ALTER TABLE CATR_ASPIRANTE ADD FOLIO_CENEVAL VARCHAR(255);
...
ALTER TABLE CAT_PERIODO_PREFICHAS ADD MONTO_PREFICHA INT DEFAULT 1600;
ALTER TABLE CAT_PERIODO_PREFICHAS ADD FECHA_INICIO_CURSO DATE DEFAULT GETDATE();
ALTER TABLE CAT_PERIODO_PREFICHAS ADD FECHA_FIN_CURSO DATE DEFAULT GETDATE();
ALTER TABLE CAT_PERIODO_PREFICHAS ADD MONTO_CURSO INT DEFAULT 550;
ALTER TABLE CAT_PERIODO_PREFICHAS ADD FECHA_INICIO_INSCRIPCION DATE DEFAULT GETDATE();
ALTER TABLE CAT_PERIODO_PREFICHAS ADD FECHA_FIN_INSCRIPCION DATE DEFAULT GETDATE();
ALTER TABLE CAT_PERIODO_PREFICHAS ADD MONTO_INSCRIPCION INT DEFAULT 4050;
ALTER TABLE CAT_PERIODO_PREFICHAS ADD FECHA_INICIO_INSCRIPCION_BIS DATE DEFAULT GETDATE();
ALTER TABLE CAT_PERIODO_PREFICHAS ADD FECHA_FIN_INSCRIPCION_BIS DATE DEFAULT GETDATE();
ALTER TABLE CAT_PERIODO_PREFICHAS ADD MONTO_INSCRIPCION_BIS INT DEFAULT 4050;
