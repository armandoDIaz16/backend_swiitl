...
CREATE TABLE CAT_CURSO_CADO(
    ...
    FK_AREA_ACADEMICA           INT NOT NULL, --FK
...
CREATE TABLE CATTR_PARTICIPANTE_PROPONE_CURSO(
    ...
    FK_PARTICIPANTE_AUTORIZA INT NOT NULL, --FK
...
-- CREACION DE PARTICIPANTE COORDINADOR Y JEFE DESAROLLO ACADEMICO
INSERT INTO CAT_PARTICIPANTE_CADO( FK_TIPO_PARTICIPANTE, FK_USUARIO)
VALUES(4, 2); -- VALIDAR PK A LA HORA DE IMPLEMENTAR
