...
INSERT INTO PER_TR_ROL_MODULO (FK_ROL, FK_MODULO) VALUES ((SELECT PK_ROL FROM PER_CATR_ROL WHERE NOMBRE = 'Tutorias-extraescolares'), (SELECT PK_MODULO FROM PER_CAT_MODULO WHERE NOMBRE = 'cargar_registro_actividades'));
