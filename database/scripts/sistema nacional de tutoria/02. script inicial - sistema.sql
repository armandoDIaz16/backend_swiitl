...
SET IDENTITY_INSERT CATR_SECCION ON;
INSERT INTO CATR_SECCION(
    PK_SECCION,
    FK_ENCUESTA,
    NOMBRE,
    NUMERO,
...
SET IDENTITY_INSERT CATR_SECCION OFF;

-- PREGUNTA GENÉRICA DE ENCUESTA PASATIEMPOS
SET IDENTITY_INSERT CATR_PREGUNTA ON;
INSERT INTO CATR_PREGUNTA(
    PK_PREGUNTA,
    FK_SECCION,
    FK_TIPO_PREGUNTA,
    ORDEN,
...
SET IDENTITY_INSERT CATR_PREGUNTA OFF;

-- RESPUESTAS POSIBLES ENCUESTA PASATIEMPOS
INSERT INTO CATR_RESPUESTA_POSIBLE(
    FK_PREGUNTA,
    RESPUESTA,
    ORDEN
) VALUES
